...
const SECTION_META = [
  {
    ...
    description:
      "Informe de un profesional de salud que describe la condición del estudiante.",
    whyItMatters:
      "Permite entender la base clínica de las necesidades de apoyo y ajuste.",
    howToObtain:
      "Solicitar a la familia el informe del médico, neuropediatra, psicólogo o terapeuta que atiende al estudiante. Debe estar firmado por el profesional.",
    placeholder:
      "Pega aquí el contenido del diagnóstico o un resumen del mismo...",
  },
  {
    key: "valoracionPedagogica",
    title: "Valoración pedagógica del docente",
    description:
      "Evaluación realizada por el docente sobre el desempeño académico y social del estudiante.",
    whyItMatters:
      "Es la base para identificar barreras y fortalezas en el contexto escolar.",
    howToObtain:
      "El docente de apoyo o director de grupo debe elaborar este documento observando al estudiante en diferentes actividades académicas y describiendo su nivel de desempeño.",
    placeholder:
      "Describe el desempeño académico y social del estudiante según tu observación...",
  },
  {
    key: "observacionAula",
    title: "Observación en el aula",
    description:
      "Registro sistemático del comportamiento y participación del estudiante durante clases.",
    whyItMatters:
      "Revela las barreras físicas, comunicativas y pedagógicas presentes en el entorno.",
    howToObtain:
      "Realiza al menos dos observaciones directas del estudiante durante clases regulares y documenta: participación, interacciones, dificultades y estrategias que funcionan.",
    placeholder:
      "Describe lo observado en el aula: participación, dificultades, estrategias que funcionan...",
  },
  {
    key: "historialAcademico",
    title: "Historial académico",
    description:
      "Registro de calificaciones, logros, dificultades y apoyos recibidos en años anteriores.",
    whyItMatters:
      "Permite identificar patrones de desempeño y evaluar la efectividad de apoyos anteriores.",
    howToObtain:
      "Consulta el sistema de información académica de la institución. Solicita al área de coordinación el historial completo de notas y observaciones del estudiante.",
    placeholder:
      "Resume el historial de notas, logros, dificultades y apoyos recibidos anteriormente...",
  },
  {
    key: "entrevistaFamilia",
    title: "Entrevista con la familia",
    description:
      "Información aportada por los padres o cuidadores sobre el estudiante.",
    whyItMatters:
      "La familia conoce aspectos del estudiante que no son visibles en el aula y son clave para personalizar los apoyos.",
    howToObtain:
      "Cita a los padres o cuidadores a una reunión. Pregunta sobre: historia de vida, rutinas en casa, intereses, miedos, qué estrategias les funcionan, expectativas.",
    placeholder:
      "Registra lo que la familia compartió sobre el estudiante, sus rutinas, intereses y contexto de vida...",
  },
  {
    key: "caracterizacion",
    title: "Caracterización del estudiante",
    description:
      "Perfil socioeconómico, cultural y de contexto del estudiante.",
    whyItMatters:
      "El contexto social y cultural influye directamente en las barreras y en las estrategias de apoyo más pertinentes.",
    howToObtain:
      "Completa la ficha de caracterización institucional (SIMAT u otro sistema). Incluye: estrato, composición familiar, acceso a tecnología, lengua materna, etc.",
    placeholder:
      "Describe el contexto socioeconómico, familiar y cultural del estudiante...",
  },
  {
    key: "mallaCurricular",
    title: "Malla curricular",
    description:
      "Estructura curricular del grado con los estándares y competencias esperados.",
    whyItMatters:
      "Permite identificar qué contenidos, competencias y logros requieren ajuste o flexibilización.",
    howToObtain:
      "Solicita al área académica la malla curricular del grado actual. Identifica las asignaturas críticas y los estándares de competencias del MEN correspondientes.",
    placeholder:
      "Describe los contenidos principales del grado, asignaturas y competencias esperadas...",
  },
  {
    key: "peiLineamientos",
    title: "PEI o lineamientos institucionales",
    description:
      "Proyecto Educativo Institucional y políticas de inclusión de la institución.",
    whyItMatters:
      "Los compromisos institucionales deben alinearse con la visión y los recursos definidos en el PEI.",
    howToObtain:
      "Consulta con el rector o coordinador el PEI vigente. Revisa específicamente el componente de inclusión y el protocolo de atención a estudiantes con discapacidad.",
    placeholder:
      "Resume los lineamientos del PEI relevantes para la inclusión y atención a la diversidad...",
  },
];
...
export default function PiarPage() {
  ...
  const [studentInfo, setStudentInfo] =
    useState<StudentInfo>(EMPTY_STUDENT_INFO);
  ...
  const [extracting, setExtracting] = useState<
    Partial<Record<keyof Sections, boolean>>
  >({});
  const [extractError, setExtractError] = useState<
    Partial<Record<keyof Sections, string>>
  >({});
  const [isGeneratingDemo, setIsGeneratingDemo] = useState(false);
  const [demoError, setDemoError] = useState("");
  const fileInputRefs = useRef<
    Partial<Record<keyof Sections, HTMLInputElement | null>>
  >({});
  ...
  async function handleGeneratePiar() {
    ...
    try {
      ...
      if (!response.ok)
        throw new Error("Error del servidor al generar el PIAR");
    ...
    <div className="min-h-screen bg-[#f5f0e8]">
      <header className="border-b border-[#1a1a1a]/10 bg-white/70 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-3xl mx-auto flex justify-between items-center px-4 py-3">
          ...
          <Link
            href="/dashboard"
            className="text-sm text-[#1a1a1a]/50 hover:text-[#1a4d2e] transition"
          >
            Ir al dashboard
          </Link>
        </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-[#1a1a1a]/60 mt-1">
                  Ingresa la información básica para identificar al estudiante
                  en el PIAR.
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2 space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setStudentInfo((p) => ({ ...p, nombre: e.target.value }))
                  }
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setStudentInfo((p) => ({ ...p, grado: e.target.value }))
                  }
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setStudentInfo((p) => ({ ...p, anio: e.target.value }))
                  }
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setStudentInfo((p) => ({ ...p, tipoDiscapacidad: v }))
                  }
                >
              ...
              <div className="sm:col-span-2 space-y-1.5">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setStudentInfo((p) => ({
                      ...p,
                      descripcionDiscapacidad: e.target.value,
                    }))
                  }
              ...
              <div className="sm:col-span-2 space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setStudentInfo((p) => ({ ...p, docente: e.target.value }))
                  }
                />
              </div>
            </div>
            ...
            return (
              <div className="rounded-2xl border border-[#1a1a1a]/10 bg-white p-6 shadow-sm space-y-5">
                ...
                <div className="rounded-xl border border-[#1a1a1a]/10 bg-[#f5f0e8]/50 px-4 py-3">
                  <p className="text-xs text-[#1a1a1a]/50 font-medium mb-0.5">
                    ¿Por qué importa?
                  </p>
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input
                    ...
                    onChange={(e) =>
                      updateSection(sectionKey, "available", e.target.checked)
                    }
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (file)
                            handlePdfUpload(sectionKey, meta.title, file);
                        }}
                      />
                      <button
                        type="button"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          updateSection(sectionKey, "content", e.target.value)
                        }
              ...
              {availableCount < 3 && (
                <div className="mt-3 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3">
                  <p className="text-sm text-amber-800">
                    Tienes menos de 3 fuentes disponibles. El PIAR generado
                    tendrá muchas secciones marcadas como pendientes. Puedes
                    continuar igual, pero se recomienda recopilar más
                    información.
                  </p>
                </div>
              )}
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p
                          className={`text-xs mt-0.5 ${section.available ? "text-green-700" : "text-amber-700"}`}
                        >
                          {section.available
                            ? "Disponible — clic para editar"
                            : "Pendiente — clic para agregar"}
                        </p>
                      </div>
                    </div>
                  </button>
            ...
            {isGenerating && (
              <div className="flex flex-col items-center justify-center gap-4 py-24">
                ...
                <p className="text-sm text-[#1a1a1a]/60">
                  Generando el PIAR, esto puede tardar unos segundos…
                </p>
              </div>
            )}
